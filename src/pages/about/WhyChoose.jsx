...
const reasons = [
  { icon: "icon-trophy",   title: "Qualité supérieure",    desc: "Des produits fabriqués selon les normes les plus strictes de l'industrie." },
  { icon: "icon-tag",      title: "Prix raisonnables",     desc: "Le meilleur rapport qualité-prix sans compromis sur l'excellence." },
  { icon: "icon-users",    title: "Service impeccable",    desc: "Une équipe dédiée à votre satisfaction à chaque étape du projet." },
  { icon: "icon-shield",   title: "Réputation solide",     desc: "Plus de 15 ans de confiance et de partenariats durables au Maroc." },
];
